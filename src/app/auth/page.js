...
export default function AuthPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'Plus Jakarta Sans, Inter, sans-serif', background: '#F8FAFC' }}>
      ...
      {/* Right Panel */}
      <motion.div initial={{ x: 40, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.5 }}
        style={{ width: '440px', flexShrink: 0, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '48px 40px', background: '#fff', boxShadow: '-4px 0 24px rgba(0,0,0,0.06)' }}>

        {/* Logo kecil di right panel */}
